def month_calculator(annual_salary, portion, total_cost):
...
if __name__ == "__main__":
    ...
    print(str( month_calculator(annual_salary, portion, total_cost)) + " is the required months to save up enough money!")

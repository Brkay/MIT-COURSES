...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        if not type(width) == int or width <= 0:   # making sure that the argument was passed as integer.
            ...
            self.width = width
        # making sure that the argument was passed as integer.
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        if pos.get_x() > self.width:   # checking if position x value is not out of room range.
            raise ValueError
        # checking if position y value is not out of room range.
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        new_pos = current_pos.get_new_position(
            self.get_robot_direction(), self.speed)
        # if robot's postion is valid robot can take action and clean,
        ...
        # otherwise his direction will be changed randomly and he will not take any action (he will not clean).
        else:
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    anim = ps3_visualize.RobotVisualization(
        num_robots, width, height, False, delay=0.5)
    # average number of steps for trial will be stored in this list.
    avrg_num_of_steps = []
    for index in range(num_trials):
        # by default we will simulate EmptyRoom type.
        ...
        while True:
            ...
            if cleaned_tiles / amt_of_tiles >= min_coverage:
                ...
                # incrementing number of steps that out robot/robots took.
                num_of_steps += 1
...
run_simulation(1, 1.0, 1, 5, 5, 3, 0.9, 1, StandardRobot)
